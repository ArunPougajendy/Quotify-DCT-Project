			...
			function editForm(id) {
				...
				var output = `
					...
					<div class="modal-body">
						...
						<input type="text" class="form-control" id="quote" aria-describedby="emailHelp" value=${myQuote.quote}>
						<label for="author"></label>
						<input type="text" class="form-control" id="author" value=${myQuote.author}>
					</div>
